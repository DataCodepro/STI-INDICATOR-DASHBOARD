...
def fun():
    ...
    fig = px.scatter(df3, x = 'SECTORS',y = 'R&D EXPENDITURE',size = 'R&D EXPENDITURE',hover_name = 'SECTORS', size_max= 120,color='SECTORS',label={'x':'SECTORS','y':'R&D EXPENDITURE(BILLION NAIRA)'})
